...
@class HDCycleScrollView;

@protocol HDCycleScrollViewDelegate <NSObject>
...
/** 图片滚动回调 */
- (void)hdCycleScrollView:(HDCycleScrollView *)cycleScrollView didScrollToIndex:(NSInteger)index;

@end

@interface HDCycleScrollView : UIView
...
@property (nonatomic, weak) id<HDCycleScrollViewDelegate> delegate;
